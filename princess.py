...
async def run_1():
    ...
    motor.run_for_degrees(port.B, 220, 150)
    ...
    motor.run_for_degrees(port.B, -435, 1000)
...
async def run_2():
    ...
    await motor.run_for_degrees(port.C, 340, 300)
    ...
    initial_position=initial_position, distance_to_cover=(degrees_for_distance(18.5)))
